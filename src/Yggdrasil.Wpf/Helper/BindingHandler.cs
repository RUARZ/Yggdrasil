...
namespace Yggdrasil.Wpf.Helper
{
    ...
    static class BindingHandler
    {
        ...
        public static BindingExpressionBase SetBinding(DependencyObject target, DependencyProperty property, PropertyInfo pInfo, object source = null)
        {
            Binding binding = CreateBinding(pInfo, source);
        ...
        public static Binding CreateBinding(PropertyInfo pInfo, object source = null)
        {
